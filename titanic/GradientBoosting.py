...
random_forest = ensemble.GradientBoostingClassifier(n_estimators=100, learning_rate=0.05, max_depth=4, random_state=1, warm_start=True)
...
cv_forest = ensemble.GradientBoostingClassifier(n_estimators=100, learning_rate=0.05, max_depth=4, random_state=1, warm_start=True)
...
f = open("titanic-resultgbt.csv", "w", newline="")
